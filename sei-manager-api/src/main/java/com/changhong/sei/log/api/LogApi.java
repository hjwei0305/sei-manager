...
public interface LogApi {
    ...
    ResultData<PageResult<LogResponse>> findByPage(@RequestBody @Valid LogSearchRequest search);
    ...
    ResultData<LogDetailResponse> detail(@RequestParam("env") String env, @RequestParam("serviceName") String serviceName, @RequestParam("id") String id);
    ...
    ResultData<List<LogResponse>> findByTraceId(@RequestParam("env") String env, @RequestParam("serviceName") String serviceName, @RequestParam("traceId") String traceId);
