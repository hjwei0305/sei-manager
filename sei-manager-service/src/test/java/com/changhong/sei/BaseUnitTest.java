 ...
 * @version 1.0.00  2020-12-01 11:40
 */
@RunWith(SpringRunner.class)
@SpringBootTest
public class BaseUnitTest {
    protected static final Logger LOG = LoggerFactory.getLogger(com.changhong.sei.core.test.BaseUnitTest.class);
    @Autowired
    public MockUserProperties properties;
//    @Autowired
    public MockUser mockUser = new LocalMockUser();
